...
//DTO(VO와 혼용해서 사용하지만 엄연히 말하면 다르다. VO에는 setter가 없다.)
/*
 * 1. Private 으로 필드 선언
 * 2. getter setter 만들기
 ...
 */
public class Test4_DTO_toString_override {
	private String name;
	private int age;
	private boolean gender;
	private String address;
	
	public Test4_DTO_toString_override(String name, int age, boolean gender, String address) {
		this.name = name;
		this.age = age;
		this.gender = gender;
	...
	// 사용자가 직접 출력용으로 만들어서 사용하는 메소드  - DTO에는 원래 getter, setter외에 다른 메소드가 오지 않는다. VO에선 가능.(?)
	public void prn() {
