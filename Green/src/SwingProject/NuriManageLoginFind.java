...
public class NuriManageLoginFind extends JFrame{
	...
	public NuriManageLoginFind() {
		...
		comboHintId.setModel(new DefaultComboBoxModel(new String[] {"나의 보물은?", "출신 초등학교는?", "가장 친한 친구는?", "가장 좋아하는 음식은?", "가장 좋아하는 책제목은?", "가장 좋아하는 영화제목은?"}));
		...
		comboHintPwd.setModel(new DefaultComboBoxModel(new String[] {"나의 보물은?", "출신 초등학교는?", "가장 친한 친구는?", "가장 좋아하는 음식은?", "가장 좋아하는 책제목은?", "가장 좋아하는 영화제목은?"}));
		...
		btnFind.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(vo.getmIdx() == 0) {
					JOptionPane.showMessageDialog(null, "입력하신 정보와 일치하는 회원정보를 찾지 못했습니다. \n 입력하신 정보를 확인해주세요.", "아이디 찾기 실패", JOptionPane.ERROR_MESSAGE);
				}else {
					JOptionPane.showMessageDialog(null, "회원님의 아이디는 '"+vo.getmMid()+"' 입니다.", "아이디 안내", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
		...
		btnFind_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(vo.getmIdx() == 0) {
					JOptionPane.showMessageDialog(null, "입력하신 정보와 일치하는 회원정보를 찾지 못했습니다. \n 입력하신 정보를 확인해주세요.", "비밀번호 찾기 실패", JOptionPane.ERROR_MESSAGE);
				}else {
					dispose();
